...
export const RECEIVE_CATEGORYS = 'receive_categorys'; //接收食品分类数据
export const RECEIVE_SHOPS = 'receive_shops'; //接收商家数组
export const RECEIVE_USER_INFO = 'receive_user_info'; //接收用户信息
export const RESET_USER_INFO = 'reset_user_info'; //重置用户信息(用于退出使用)

export const RECEIVE_GOODS = 'receive_goods'; //接收商品数组
export const RECEIVE_RATINGS = 'receive_ratings'; //接收商品评价的数组
export const RECEIVE_INFO = 'receice_info'; //接收商家信息